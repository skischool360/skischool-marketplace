...
class SelfiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create selfy" do
    assert_difference('Selfie.count') do
      post selfies_url, params: { selfy: { contestant_id: @selfy.contestant_id, date: @selfy.date, link: @selfy.link, location_id: @selfy.location_id, social_network: @selfy.social_network } }
    end
  ...
  test "should update selfy" do
    patch selfy_url(@selfy), params: { selfy: { contestant_id: @selfy.contestant_id, date: @selfy.date, link: @selfy.link, location_id: @selfy.location_id, social_network: @selfy.social_network } }
